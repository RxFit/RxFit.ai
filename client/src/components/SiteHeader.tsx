...
export default function SiteHeader() {
  ...
  return (
    <>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 z-[100] btn-primary px-4 py-2 rounded-lg"
      >
        Skip to main content
      </a>
      <nav aria-label="Main navigation" className="fixed top-0 w-full z-50 backdrop-blur-md bg-background/80 border-b border-border" data-testid="site-header">
